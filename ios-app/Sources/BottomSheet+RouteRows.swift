...
/// Active-route builders live separately from the generic home/search rows so
/// the bottom sheet can keep a readable route-focused surface without turning
/// BottomSheet+Rows into another catch-all file.
